...
class SpeechToText extends Ibm
{
     ...
     * @return $this
     */
    public function recognize($pathToFile, $contentType = self::CONTENT_TYPE , $lng , $uri = false)
    {
    ...
    public function getToken() {
        $cookie = $this->getSetCookieHeader();
        $token_cookie = $cookie[1];
        $token = substr(explode(';', $token_cookie)[0], 12);
        return $token;
    }
